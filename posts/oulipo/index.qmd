...
subtitle: "The First Large Language Model and, Has Machine Learning Solved Oulipo?"
author: "Tom Savage"
...
---
<!-- [Main Source](https://monoskop.org/images/a/a4/Motte_Warren_F_ed_Oulipo_A_Primer_of_Potential_Literature.pdf)
 -->

<!-- Outline of Oulipo 
Examples 
The first language model
Where to LLMs fit in Oulipo 
Chinese Room Diversion
LLM questions and answer 
Reveal all... and help using LLMs. -->
...
However, as soon as it achieves this task and text becomes indistinguishable, the underlying language structure that has generated it becomes obscured, and the impact is lost. Would a haiku be a haiku if you couldn't tell immediately tell it's structure?
