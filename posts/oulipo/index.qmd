...
s_string = {
  if (rnd === 0) {
    return html`<img src="logo.png" title="Basile Morin, [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0)">`
  }
  else {
    return html`<img src="other_logo.png" title="Basile Morin, [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0)">`
  }
}
```
