...
The 'amount' of each descriptor is obtained by prompting an LLM, and the respective values converted to an individual cyan, magenta, yellow, and black value, resulting in a single CMYK colour. 
