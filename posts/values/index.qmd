...
subtitle: "The Inescapable, Neverending Race for Values"
...
**Relevant articles published after this post**

- [China deploys censors to create socialist AI](https://www.ft.com/content/10975044-f194-4513-857b-e17491d2a9e9)
    - Large language models are being tested by officials to ensure their systems ‘embody core socialist values’

- [The Chinese team behind DeepSeek V2 write about lagging on the Humanity-Moral subset of MMLU, due to its "American values"](https://x.com/JvNixon/status/1804267376839639490)
    - _For example, when evaluated on MMLU, although DeepSeek-V2 achieves comparable or superior performance on the majority of testsets compared with its competitors like Mixtral 8x22B, it still lags behind on the Humanity-Moral subset, which is mainly associated with American values._
...
Theodosius' grave is now lost, most likely beneath the Fatih Mosque where Islamic minorets now anchor the heavens to the city and vice versa.
...
The stakes are supposedly high; a well-trained model in language or image generation may serve as a powerful tool to flood social media with undetectable posts aligned with a given set of values, infiltrate computer networks, or aid in obtaining technological advancements or scientific discovery. 
...
As a city it has ultimately benefited, layers of history have resulted in a  _broadly interesting place to visit_.^[Five word summary for the billboard.] 
