---
title: "GenAI and the Inescapable & Neverending Race for Values"
...
People have recently blamed Google's corporate culture for a series of questionable large-langauge model and image generation failures, generating enormous amounts of cut-through. 
...
With this in mind, how do Islamic values map onto the existential threat of AI?What would a language model imbued with Islamic values provide? 
...
The act of bringing 'something' into existance is broadly acceptable within this framework (and [sometimes encouraged](https://sav.phd/posts/transubstantiation/)).
