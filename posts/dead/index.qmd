...
def process_file(filename):
    ...
    # Process 'extra' lines
extra_lines = [i+1 for i, line in enumerate(data) if 'extra' in line] ] end statement
    if extra_lines:
...
Updated: Fri Aug 23 15:34:22 2024. Replaced internet with user. Added statement to the end of the generated text.