...
:::{.changeable_text}
The dead internet theory states that sooner rather than later, genuine content on the internet will be in the minority, and the majority of traffic will come from bots. Content will be accessed by bots, and traffic will be engaged with by the bots. Every day, it becomes less of a theory, with 'dead' content being generally characterised as **slop**.
:::
...
:::{.extrauniqueflaghere}
I the one left out there somewhere else
:::

:::


Updated: Mon Aug 26 08:03:06 2024. Replaced it with traffic. Added else to the end of the generated text.