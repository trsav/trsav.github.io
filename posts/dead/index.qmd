...
:::{.changeable_text}
The dead content theory states that sooner rather than later, the content on the internet will be in the minority, and the majority of traffic will come from bots. Content will be accessed by bots, and traffic will be engaged only by the bots. Every day, it becomes less of a problem with 'dead' content being generally characterised as **slop**.
:::
...
:::{.extrauniqueflaghere}
I   t h e   o n e   l e f t   o u t   t h e r e   s o m e w h e r e   e l s e   e n t i r e l y   a n y w a etc
:::

:::


Updated: Mon Sep  2 08:05:49 2024. Replaced than with than. Added etc to the end of the generated text.