...
:::{.changeable_text}
The dead internet theory states that sooner rather than later, genuine activity on the internet will be in the minority, and the majority of traffic will come from bots. Content will be accessed by bots, and it will be engaged with by the bots. Every day, it becomes less of a theory, with 'dead' content being generally characterised as **slop**.
:::
...
Updated: Sat Aug 24 20:03:14 2024. Replaced produced with accessed. Added out to the end of the generated text.